        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex-shrink-0 mr-4">
            ...
            <Link to="/" className="block" aria-label="Cruip">
              <div className='flex justify-center w-12 h-12'>
                <img src="https://www.greatplacetowork.in/wp-content/uploads/2021/11/GPTW-Corporate-logo-1.png" alt="" />
              </div>
            </Link>
          </div>
          ...
          <nav className="flex flex-grow">
            <ul className="flex flex-grow justify-end flex-wrap items-center">
              ...
              <li>
                <Link to="/register" className="btn-sm text-gray-200 bg-primary hover:bg-gray-800 ml-3 px-4 py-2 flex items-center justify-center rounded-md">
                  <span>Sign up</span>
