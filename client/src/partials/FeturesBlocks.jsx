...
function FeaturesBlocks() {
  return (
    <section className="relative">
      ...
      <div className="absolute inset-0 top-1/2 md:mt-24 lg:mt-0 bg-primary pointer-events-none" aria-hidden="true"></div>
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Insights into building a winning peoples strategy</h2>
            <p className="text-xl text-gray-600">The assessment process reveals key factors that define as well as compare the culture at an organization with that of its competitors. Great Place to Work® offers deep dive into these insights through its comprehensive reports covering survey scores, benchmarking and in-depth evaluation of the organizations’ people practices. In addition, the Leadership Presentations and Action Planning Workshops pave the way to building a Great Workplace culture.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Trust Index action planning</h4>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Recommendations & insights</h4>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Comprehensive reporting</h4>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Basic reporting with benchmarks</h4>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Basic reporting</h4>
            </div>
          </div>
